...
This will change the app version both in package.json and app's public/manifest.json
...
Read all about Overwolf's public/manifest.json mechanism [here](https://overwolf.github.io/docs/api/manifest-json#welcome-to-the-manifestjson-file).
In our public/manifest.json file, we have [```{ "start_window": "background" }```](https://overwolf.github.io/docs/api/manifest-json#start_window) defined.
...
property the background window has in our public/manifest.json.
